...
public sealed record UserCreated(Guid UserId,string Email,string TimeZoneCountry,string TimeZone,Status Status = Status.Active);
...
public sealed record TimeZoneModified(Guid UserId,string Country,string Time);